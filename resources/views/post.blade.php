    ...
    <div class="container-fluid ms-1">
        <div class="row justify-content-center mb-4">
            <div class="col-md-8">
                ...
                <h6 class="mb-4">By : <a href="/author/{{ $post->user->username }}" class="text-decoration-none">{{ $post->user->name }}</a> in <a href="/categories/{{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->name }}</a> ({{ $post->created_at->diffForHumans() }})</h6>
